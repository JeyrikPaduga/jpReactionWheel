...
public class Wheel extends ShapeRenderer{
    ...
    private static final Color BLUE = new Color(52/255f, 352/255f,219/255f,1f);
    ...
    public void render(){
        ...
        this.circle(center.x, center.y, radius/1.1f);
    ...
    public void checkInput(){
        ...
        if (gameRunning){
            if(touched && targetInRange()){
                ...
                float ang = 0.0f + rnd.nextFloat() * (300f - 0f);
